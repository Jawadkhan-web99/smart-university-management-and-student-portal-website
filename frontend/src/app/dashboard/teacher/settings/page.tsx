...
export default function TeacherSettingsPage() {
  ...
  return (
    <ProtectedRoute allowedRoles={['teacher']}>
      <DashboardShell role="teacher" title="Faculty Portal Settings">
          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-sm space-y-6">
            ...
            <div className="pt-4 border-t border-slate-100 dark:border-slate-800">
              ...
              <p className="text-xs text-slate-500 mt-0.5">
                Customize faculty console appearance between light and dark modes
              </p>
            ...
            <div className="pt-6 border-t border-slate-100 dark:border-slate-800 space-y-3">
              ...
              <p className="text-xs text-slate-500">
                Authenticated as <strong>{user?.email}</strong> with faculty role authorization. Session secured by JWT bearer encryption.
              </p>
            </div>
          </div>
        </div>
